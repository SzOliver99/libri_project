<script>
	import { BookOpen, HouseIcon, Info, ShoppingCart } from 'lucide-svelte';
	...
	const categories = [
		...
		{ href: '#', title: 'Könyvek', icon: BookOpen },
		{ href: '#', title: 'Rólunk', icon: Info },
		{ href: '#', title: 'Kosár', icon: ShoppingCart }
	];
